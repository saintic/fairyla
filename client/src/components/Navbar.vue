                ...
                >
                    ...
                    <el-submenu index="/control" v-if="isControl()">
                        ...
                        <el-menu-item index="/control/setting">
                            <i
                                class="saintic-icon saintic-icon-system-setting"
                            ></i>
                            配置管理
                        </el-menu-item>
                        <el-menu-item index="/control/hook">
                            <i class="saintic-icon saintic-icon-plugin"></i>
                            钩子扩展
                        </el-menu-item>
                        <el-menu-item index="/control/user">
                            <i
                                class="saintic-icon saintic-icon-user-manager"
                            ></i>
                            用户管理
                        </el-menu-item>
                    ...
                    <el-submenu index="/user" v-else>
                        ...
                        <el-menu-item index="/user/feed">
                            <i class="saintic-icon saintic-icon-rss"></i>
                            我的RSS
                        </el-menu-item>
                        <el-menu-item>-------------</el-menu-item>
                        <el-menu-item index="/control" v-if="isAdmin">
                            <i
                                class="saintic-icon saintic-icon-site-manager"
                            ></i>
                            站点管理
                        </el-menu-item>
                        <el-menu-item index="/logout">
